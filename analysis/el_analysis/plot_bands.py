...
dos_data[:, 0] -= vbm  # Subtract VBM from the DOS energies
...
ax1.set_ylim(-5, 9)  # Adjust y-limits accordingly
...
ax2.axhline(0, linewidth=2, label="Valence band maximum", color="red")
...
ax2.axhline(cbm - vbm, linewidth=2, label="Conduction band minimum", color="blue")

# Compute the band gap
band_gap = cbm - vbm 

props = dict(boxstyle='round', facecolor='wheat', alpha=0.5)
ax1.text(0.65, 0.45, f"Gap = {band_gap:.3f} eV",
